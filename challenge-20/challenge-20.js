(function(win,doc){
    ...
    */
    ...
    //$inputUsername.input.append(username)
    console.log($inputUsername.value)
    //console.log(typeof($inputUsername.input.value ))
    ...
    Caso contrário, mostre um alerta com a mensagem:
        - "Não enviado."
    */
    $button.addEventListener( 'click', isValidEmail, function(event){
        console.log("entrei")
        event.preventDefault();
        var ok = true;
        if(! $inputUsername ){
            console.log("Preencha o nome do usuário!")
            ok = false
        }
        if(! $inputEmail ){
            console.log("Preencha E-mail!")
            ok = false
        } else{
        ...
        var confMess = confirm("Tem certeza que deseja enviar o formulário?")
